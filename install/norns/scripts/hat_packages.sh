...
sudo cp -f /home/we/nordhat/install/norns/files/systemd-udevd.service /lib/systemd/system/
sudo cp -f /home/we/nordhat/install/norns/files/interfaces /etc/network
